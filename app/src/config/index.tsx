...
const SOL_USD_priceFeedPublicKey = "J83w4HKfqxwcq3BEMMkPFSppX3gqekLyLJBexebFVkix"
...
export default {
    priceFeedKey: SOL_USD_priceFeedPublicKey, // Assuming this is the public key for the price feed program
    PRICE_ACCOUNT_SEED,
    MASTER_ACCOUNT_SEED,
    BET_ACCOUNT_SEED,
